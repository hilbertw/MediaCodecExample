 ...
 *
 */
public class UDPVideoDecoderActivity extends Activity implements SurfaceHolder.Callback {
	private UDPVideoDecoderThread mVideoDecoder;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mVideoDecoder = new UDPVideoDecoderThread();
	}
